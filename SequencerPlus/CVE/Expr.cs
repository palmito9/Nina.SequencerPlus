...
using static NINA.Plugin.SequencerPlus.Symbol;
using Array = NINA.Plugin.SequencerPlus.Symbol.Array;
        ...
        public void ExtensionFunction(string name, FunctionArgs args) {
            ...
            try {
                ...
                if (name == "altitude") {
                    ...
                    double _longitude = SequencerPlusPlugin.GetLongitude();
                    double _latitude = SequencerPlusPlugin.GetLatitude();
                    ...
                    foreach (string sRef in References) {
                        ...
                        if (!found || sym == null) {
                            ...
                            if (sym != null) {
                                ...
                                found = false;
                                if (SymbolCache.TryGetValue(SequencerPlusPluginObject.Globals, out cached)) {
                                    Symbol global;
