...
namespace NINA.Plugin.SequencerPlus {
    ...
    public class SetConstant : Symbol, IValidatable {
        ...
        public void SetGlobalName (string name) {
            PropertyInfo pi = SequencerPlusPluginObject.GetType().GetProperty(GlobalName);
            pi?.SetValue(SequencerPlusPluginObject, name, null);
        }
        ...
        public void SetGlobalValue(string expr) {
            PropertyInfo pi = SequencerPlusPluginObject.GetType().GetProperty(GlobalValue);
            pi?.SetValue(SequencerPlusPluginObject, expr, null);
        }
        ...
        public bool AllProfiles {
            ...
            set {
                if (GlobalName != null) {
                    PropertyInfo pi = SequencerPlusPluginObject.GetType().GetProperty(GlobalAll);
                    pi?.SetValue(SequencerPlusPluginObject, value, null);
                }
                allProfiles = value;
            }
        }
